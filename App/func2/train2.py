...
DATASET_PATH = "../../files/garbage-dataset"

# Parámetros del modelo
IMG_SIZE = (224, 224)
BATCH_SIZE = 32
EPOCHS = 6  # Puedes aumentar si tienes tiempo
...
train_generator = datagen.flow_from_directory(
    ...
    subset="training",
    shuffle=True  # Mezcla imágenes en cada época
)
...
MODEL_PATH = "static/models/garbage_classifier.h5"
...
if os.path.exists(MODEL_PATH):
    ...
    print(" Entrenamiento finalizado. Modelo guardado en 'static/models/garbage_classifier.h5'.")
